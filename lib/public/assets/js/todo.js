(function() {
  ...
  TodoView = (function(_super) {
    ...
    TodoView.prototype.template = "<%= model.get(\"text\") %> <a class=\"delete\">x</a> <a class=\"edit\">edit</a>";
  ...
  TodoFormView = (function(_super) {
    ...
    TodoFormView.prototype.onKeyUp = function(e) {
      if (e.keyCode === 13) return this.add();
    };
